...
@section('navbar')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Edit Kota Kabupaten</h6>
    </nav>
@endsection
@section('content')
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Edit Kota Kabupaten</h6>
                        </div>
                    </div>
                    <div class="card-body px-4 pb-2">
                        <form method="POST" action="{{ route('kotakab.update', $kotakab->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group input-group-static my-3">
                                        ...
                                        <input type="text" name="nama_kotakab" value="{{ $kotakab->nama_kotakab }}" class="form-control">
                                    </div>
                                </div>
                            </div>
