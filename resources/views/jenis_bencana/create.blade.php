...
@section('navbar')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="kotakab">Jenis Bencana</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">Tambah Jenis Bencana</h6>
    </nav>
@endsection
@section('content')
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Tambah Jenis Bencana</h6>
                        </div>
                    </div>
                    <div class="card-body px-4 pb-2">
                        <form method="POST" action="{{ route('jenis_bencana.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
