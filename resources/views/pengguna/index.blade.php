            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-body px-3 pb-2">
                        <a href="{{ route('pengguna.create') }}"><button class="btn btn-success">Tambah Data</button></a>
                                    ...
                                    @foreach ($data as $pengguna)
                                        <tr>
                                            <td class="align-middle">
                                                <span
                                                    class="text-sm font-weight-bold">{{ $pengguna->nama_user }}
                                                </span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="text-sm font-weight-bold">{{ $pengguna->email }}
                                                </span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="text-sm font-weight-bold">{{ Str::title($pengguna->role) }}
                                                </span>
                                            </td>
                                            <td class="align-middle">
