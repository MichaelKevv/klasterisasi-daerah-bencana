                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Data Kriteria</h6>
                        </div>
                    </div>
                    <div class="card-body px-3 pb-2">
                        <a href="{{ route('kriteria.create') }}"><button class="btn btn-success">Tambah Data</button></a>
                                    ...
                                    @foreach ($data as $kriteria)
                                        <tr>
                                            <td class="align-middle">
                                                <span class="text-sm font-weight-bold">{{ $kriteria->kode_kriteria }}
                                                </span>
                                            </td>
                                            <td class="align-middle">
                                                <span class="text-sm font-weight-bold">{{ $kriteria->nama_kriteria }}
                                                </span>
                                            </td>
                                            <td class="align-middle">
                                                ...
                                                <a href="{{ route('kriteria.destroy', $kriteria->id) }}"
