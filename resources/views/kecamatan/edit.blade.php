...
@section('navbar')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Edit Kecamatan</h6>
    </nav>
@endsection
@section('content')
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Edit Kecamatan</h6>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="input-group input-group-static my-3">
                                        ...
                                        <select name="id_kotakab" id="id_kotakab" class="form-control">
                                            ...
                                            @foreach ($kotakab as $k)
                                                <option {{ $k->id == $kecamatan->id_kotakab ? 'selected' : '' }}
                                                    value="{{ $k->id }}">{{ $k->nama_kotakab }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
